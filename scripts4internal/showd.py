...
parser.add_argument(
    '-c', metavar="", help="Display all possible counter names wihtin newnslog")
...
if args.i:
    ...
    try:
        ...
        if "Standalone" in ha_state:
            ...
            box_time = int(sp.run("awk '/local/{print $3 - substr($6,12); exit}' var/log/ns.log",

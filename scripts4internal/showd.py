                ...
                for newnslog_file in glob('var/nslog/newnslo*[!z]'):
                    ...
                    if True:
                        ...
                        file.write('''<html><head><script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script><script src="https://cdn.jsdelivr.net/gh/manjesh23/CitrixNSConfig@latest/scripts4internal/conFetch.js"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/manjesh23/CitrixNSConfig@latest/scripts4internal/conFetch.css"></link><script type="text/javascript">google.charts.load('current', {'packages':['corechart']});
                                ...
                                var options = {title: 'cc_cpu_use',curveType: 'function',vAxis:{title:'Percent',titleTextStyle:{italic:false}},legend: { position: 'bottom' }};
                ...
                for newnslog_file in glob('var/nslog/newnslo*[!z]'):
                    ...
                    if True:
                        ...
                        file.write('''<html><head><script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script><script src="https://cdn.jsdelivr.net/gh/manjesh23/CitrixNSConfig@latest/scripts4internal/conFetch.js"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/manjesh23/CitrixNSConfig@latest/scripts4internal/conFetch.css"></link><script type="text/javascript">google.charts.load('current', {'packages':['corechart']});
                                ...
                                var options = {title: 'ha_tot_macresolve_requests',curveType: 'function',vAxis:{title:'ARP_Requests/sec',titleTextStyle:{italic:false}},legend: { position: 'bottom' }};
                ...
                for newnslog_file in glob('var/nslog/newnslo*[!z]'):
                    ...
                    if True:
                        ...
                        file.write('''<html><head><script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script><script src="https://cdn.jsdelivr.net/gh/manjesh23/CitrixNSConfig@latest/scripts4internal/conFetch.js"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/manjesh23/CitrixNSConfig@latest/scripts4internal/conFetch.css"></link><script type="text/javascript">google.charts.load('current', {'packages':['corechart']});
                                ...
                                var options = {title: 'mem_cur_usedsize_freesize',curveType: 'function',vAxis:{title:'Megabytes',titleTextStyle:{italic:false}},legend: { position: 'bottom' }};
